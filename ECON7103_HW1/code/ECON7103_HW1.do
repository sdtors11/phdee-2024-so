...
* Start by clearing everything
	...
	clear all 
	// Note that in Stata, tabs don't mean anything, so I use them to organize nested parts of code to keep things looking clean.
	set more off 
	// Prevents you from having to click more to see more output
...
cd "/Users/sedators/Desktop/ECON7103_2024/phdee-2024-so/ECON7103_HW1/output"
	
log using "ECON7103HW1.txt", replace
